...
public class Main {
    ...
    public void addSingleProductsToCart(String product_Name, String quantity) {
        ...
        quantityBox = driver.findElement(By.xpath("//div[@class='products']/div[@class='product']/h4[contains(text(), '" + product_Name + "')]/parent::div/div[@class='stepper-input']/input"));
        ...
        product = driver.findElement(By.xpath("//div[@class='products']/div[@class='product']/h4[contains(text(), '" + product_Name + "')]/parent::div/div[@class='product-action']/button"));
